...
class Game
    ...
    SEED_GROWER = [[12,12],[13,12],[14,12],[16,12],[12,13],[15,14],[16,14],
                  [13,15],[14,15],[16,15],[12,16],[14,16],[16,16]]
    ...
    def draw_hud
        if simulation_over?
            ...
            @font.draw("#{@status_message} in #
            {@generation} generations after #{time_in_seconds}
            seconds", 110, 300, 10)
        else
